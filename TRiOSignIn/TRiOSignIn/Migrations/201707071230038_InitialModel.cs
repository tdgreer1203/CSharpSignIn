namespace TRiOSignIn.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        StudentId = c.String(nullable: false, maxLength: 100),
                ...
                c => new
                    {
                        ...
                        ForceClosed = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
        ...
        {
            DropForeignKey("dbo.Visits", "StudentId", "dbo.Students");
            DropForeignKey("dbo.Visits", "ReasonId", "dbo.Reasons");
            DropForeignKey("dbo.Visits", "LabId", "dbo.Labs");
            ...
            DropIndex("dbo.Visits", new[] { "LabId" });
            DropIndex("dbo.Visits", new[] { "StudentId" });
